    ...
    return (
        ...
        >
            {session.side_a_label && (
                <MunicipalityWatermark name={session.side_a_label} className="-top-6 -left-6 size-32 text-6xl sm:size-40 sm:text-7xl" />
            )}
            {session.side_b_label && (
                <MunicipalityWatermark name={session.side_b_label} className="-right-6 -bottom-6 size-32 text-6xl sm:size-40 sm:text-7xl" />
            )}
