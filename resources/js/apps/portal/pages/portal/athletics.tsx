...
export default function PortalAthletics({
    meet,
    days,
    selectedDay,
    medalTotals,
    ...
    return (
        <>
            ...
            <div className="flex flex-col gap-6">
                <PortalHero
                    title="Athletics"
                    description="Real schedule and, once validated, top-3 placements — no live per-athlete tracking."
                />
                    ...
                    <PortalSectionHeader
                        ...
                        action={
                            <PortalDaySwitcher
                                ...
                                baseUrl={publicAthletics(meet.id).url}
                            />
                        }
                    />
                )}
                        ...
                        {slots.map((slot) => (
                            ...
                            >
                                <div className="flex flex-wrap items-center justify-between gap-2">
                                    <span
                                        className={`rounded-full px-2 py-0.5 text-xs font-medium ${statusTone[slot.status]}`}
                                    >
                                ...
                                {slot.official_as_of && (
                                    <p className="mt-2 text-xs text-[var(--portal-muted-foreground)]">
                                        Official as of {slot.official_as_of}
                                    </p>
                                )}
                            </div>
                        ))}
