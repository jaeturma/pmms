...
## Objective
Implement softball/baseball live scoreboard UI with inning state, bases, balls, strikes, outs, line score, runs/hits/errors, play-by-play, comparisons, top performers, pitchers, fallback state, and provisional-score notice.
...
docs/phases/phase-08-ui-ux-visual-alignment/WP-08-12-softball-and-baseball-live-scoreboard-ui.md
```
...
Create:
```text
docs/reports/phase-08/WP-08-12-completion.md
```
