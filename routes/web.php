...
use App\Http\Controllers\MeetReadinessController;
...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::post('dashboard/medical-clearance/mark-attached', [DashboardController::class, 'markCertificateAthletesMedicallyCleared'])
        ->name('dashboard.medical-clearance.mark-attached');
    ...
    Route::patch('coach/onboarding-requests/{coachOnboardingRequest}/information', [CoachAssignmentRequestController::class, 'updateOnboardingInformation'])->name('coach.onboarding-requests.information.update');
    Route::delete('coach/onboarding-requests/{coachOnboardingRequest}', [CoachAssignmentRequestController::class, 'destroyOnboarding'])->name('coach.onboarding-requests.destroy');
    ...
    Route::get('monitoring/readiness', MeetReadinessController::class)->name('monitoring.readiness.index');
    ...
    Route::post('results/{result}/request-correction', [ResultWorkflowController::class, 'requestCorrection'])->name('results.request-correction');
